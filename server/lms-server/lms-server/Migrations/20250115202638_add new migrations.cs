        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_BookRequests_AspNetUsers_ClientId",
                        column: x => x.ClientId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "210b2b0d-e241-4755-978e-f0cc96d06284", null, "Library Manager", "LIBRARY MANAGER" },
                    { "325aef44-cb20-4a9f-9d54-9516697c1938", null, "Librarian", "LIBRARIAN" },
                    { "5930240c-f4f7-49f0-bd78-23cb1db6bed9", null, "Client", "CLIENT" }
                });
