...
namespace lms.Tests.ServicesTests.Books
{
    ...
    {
        private readonly Mock<LmsDbContext> _dbContextMock;
        private readonly BookImportService _bookImportService;

        public BookImportServiceTests()
        {
            _dbContextMock = new Mock<LmsDbContext>(new DbContextOptions<LmsDbContext>());
        ...
        //    _dbContextMock.Setup(db => db.Set<Book>()).Returns(mockBookSet.Object);
